function statsTable = generateStatsTableForGroups(vdo,...
...
% Set the following to export latencies - note, this should be expanded to
% look for a passed argument, also need to make sure negative vs. positive
% latency works correctly in the code below.  Currently fails for indexed
% case
useGrpLatency = false;
            ...
            for dataIndex = 1:count
                ...
                for iG = 1:nGrps
                    ...
                    if useGrpLatency
                        ...
                        newGrp.copyExistingGroup(theGrp,'OrphanGroup');
                        theGrp = newGrp;
                    end
